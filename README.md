...
|  |[Left Rotation](https://www.hackerrank.com/challenges/array-left-rotation/problem)| <ul><li>[C#](./DataStructures/Arrays/Left%20Rotation/Solution.cs)</li><ul> | _O(n)_ | _O(n)_| Easy | 20 | n = number of integers ||
