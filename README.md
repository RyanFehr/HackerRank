...
|  |[Grid Challenge](https://www.hackerrank.com/challenges/grid-challenge)| <ul><li>[Java](./Algorithms/Greedy/Grid%20Challenge/Solution.java)</li><li>[C#](./Algorithms/Greedy/Grid%20Challenge/Solution.cs)</li><ul> | _O(n*(n+k)))_ | _O(n)_| Easy | 20 | k = 26 (Number of letters in English alphabet) ||
