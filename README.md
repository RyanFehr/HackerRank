...
|  |[Luck Balance](https://www.hackerrank.com/challenges/luck-balance)| <ul><li>[Java](./Algorithms/Greedy/Luck%20Balance/Solution.java)</li><li>[C#](./Algorithms/Greedy/Luck%20Balance/Solution.cs)</li><ul> | _O(n log(n))_ | _O(n)_ | Easy | 20| ||
