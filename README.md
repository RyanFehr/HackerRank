...
|   | [ACM ICPC Team](https://www.hackerrank.com/challenges/acm-icpc-team)| <ul><li>[Java](./Algorithms/Implementation/ACM%20ICPC%20Team/Solution.java)</li><li>[C#](./Algorithms/Implementation/ACM%20ICPC%20Team/Solution.cs)</li><ul> | _O(m* n^2)_ | _O(n)_ | Easy | 25| n = number of attendees, m = number of topics ||
