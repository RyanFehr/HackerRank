...
|   | [Making Anagrams](https://www.hackerrank.com/challenges/making-anagrams)| <ul><li>[Java](./Algorithms/Strings/Making%20Anagrams/Solution.java)</li><li>[C#](./Algorithms/Strings/Making%20Anagrams/Solution.cs)</li><ul> | _O(n)_ | _O(m + n)_ | Easy | 30| m and n are length of two input strings ||
