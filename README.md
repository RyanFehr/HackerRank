...
|   | [Append and Delete](https://www.hackerrank.com/challenges/append-and-delete)| <ul><li>[Java](./Algorithms/Implementation/Append%20and%20Delete/Solution.java)</li><li>[C#](./Algorithms/Implementation/Append%20and%20Delete/Solution.cs)</li><ul> | _O(min(|s|,|t|)_ | _O(|s| + |t|)_ | Easy | 20|  ||
