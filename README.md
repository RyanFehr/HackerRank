...
|  |[Maximum Perimeter Triangle](https://www.hackerrank.com/challenges/maximum-perimeter-triangle)| <ul><li>[Java](./Algorithms/Greedy/Maximum%20Perimeter%20Triangle/Solution.java)</li><li>[C#](./Algorithms/Greedy/Maximum%20Perimeter%20Triangle/Solution.cs)</li><ul> | _O(n log (n))_ | _O(n)_| Easy | 20 | ||
