...
|   | [Anagram](https://www.hackerrank.com/challenges/anagram)| <ul><li>[Java](./Algorithms/Strings/Anagram/Solution.java)</li><li>[C#](./Algorithms/Strings/Anagram/Solution.cs)</li><ul> | _O(n)_ | _O(n)_ | Easy | 25| ||
