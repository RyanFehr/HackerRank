...
|   | [Sherlock and the Valid String](https://www.hackerrank.com/challenges/sherlock-and-valid-string)| <ul><li>[Java](./Algorithms/Strings/Sherlock%20and%20Valid%20String/Solution.java)</li><li>[C#](./Algorithms/Strings/Sherlock%20and%20Valid%20String/Solution.cs)</li><ul> | _O(n)_ | _O(1)_ | Medium | 35| ||
