/*
 ...
 Thoughts :
 1. Get an array of all the player scores. Iterate through all player scores and create a new array 
    which doesn't contain any repeated player scores. Let us call the new array, playerScores.
 2. Let total levels to be played by Alice is N.
 ...
 9. Now start processing Alice's score in all subsequent levels inside a loop
    ...
    9.5 Reduce N by 1.
    9.6 Print R.
    9.7 Go to step 9.1 if there are more levels left to be played (i. e N>0).

 Time Complexity:  O(n) - One scan required to get non-duplicate scores (n). Another scan required to decide
